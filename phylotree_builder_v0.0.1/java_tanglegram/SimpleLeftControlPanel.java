...
import egps2.module.graphic.swing.gui.panels.DataImportPanel_OneTypeOneFile;
import egps2.UniSoftInstance;
...
public class SimpleLeftControlPanel extends JPanel{
	...
	public SimpleLeftControlPanel(TanglegramController controller) {
		...
		Font globalFont = UniSoftInstance.getLaunchProperty().defaultFont;
	...
	private void addJXTaskPanes(JXTaskPaneContainer jxTaskPaneContainer) {
		Font defaultTitleFont = UniSoftInstance.getLaunchProperty().defaultTitleFont;
